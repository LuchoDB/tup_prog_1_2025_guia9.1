//Codigo base para los incisos a y b del ejercicio 1.2
...
namespace Ejercicio1._2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Alumno con mayor nota: {nombres[posMayor]}. Su nota es: {notas[posMayor]}");
            Console.WriteLine($"Alumno con menor nota: {nombres[posMenor]}. Su nota es: {notas[posMenor]}");
            #endregion

            #region Alumnos que superan el promedio
